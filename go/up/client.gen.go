// Package up provides primitives to interact with the openapi HTTP API.
//
...
// ServerUrlHttpsapiUpComAuapiv1 defines the Server URL for https://api.up.com.au/api/v1
const ServerUrlHttpsapiUpComAuapiv1 = "https://api.up.com.au/api/v1"
...
func NewGetAccountsRequest(server string, params *GetAccountsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.FilterAccountType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[accountType]", *params.FilterAccountType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.FilterOwnershipType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[ownershipType]", *params.FilterOwnershipType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetAccountsAccountIdTransactionsRequest(server string, accountId string, params *GetAccountsAccountIdTransactionsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.FilterStatus != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[status]", *params.FilterStatus, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.FilterSince != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[since]", *params.FilterSince, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: "date-time"}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.FilterUntil != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[until]", *params.FilterUntil, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: "date-time"}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.FilterTag != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "filter[tag]", *params.FilterTag, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewPatchTransactionsTransactionIdRelationshipsCategoryRequestWithBody(server string, transactionId string, contentType string, body io.Reader) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "transactionId", transactionId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
