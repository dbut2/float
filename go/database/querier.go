...
type Querier interface {
	...
	ListRulesByBucket(ctx context.Context, bucketID uuid.UUID, userID uuid.UUID) ([]ListRulesRow, error)
	ListRulesForUser(ctx context.Context, userID uuid.UUID) ([]ListRulesRow, error)
