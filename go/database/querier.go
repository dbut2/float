...
type Querier interface {
	...
	GetBucketHealthNotification(ctx context.Context, bucketID uuid.UUID, userID uuid.UUID) (sql.NullTime, error)
	...
	SetBucketHealthNotifiedAt(ctx context.Context, bucketID uuid.UUID, userID uuid.UUID) error
